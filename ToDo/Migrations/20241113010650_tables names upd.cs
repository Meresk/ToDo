...
{
    /// <inheritdoc />
    public partial class tablesnamesupd : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    User_lw9_02Id = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Notes_lw9_02", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Notes_lw9_02_Users_lw9_02_User_lw9_02Id",
                        column: x => x.User_lw9_02Id,
